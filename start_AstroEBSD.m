...
if exist(fullfile(Astro_FP, 'testing'), 'dir') ~= 7
    mkdir(fullfile(Astro_FP, 'testing'));
end
if exist(fullfile(Astro_FP, 'outputs'), 'dir') ~= 7
    mkdir(fullfile(Astro_FP, 'outputs'));
end
if exist(fullfile(Astro_FP, 'decks'), 'dir') ~= 7
    mkdir(fullfile(Astro_FP, 'decks'));
end

%build the paths
addpath(fullfile(Astro_FP, 'gen'));
addpath(fullfile(Astro_FP, 'bin'));
addpath(fullfile(Astro_FP, 'utils'));
addpath(fullfile(Astro_FP, 'phases'));
addpath(fullfile(Astro_FP, 'testing'));
addpath(fullfile(Astro_FP, 'decks'));
addpath(fullfile(Astro_FP, 'outputs'));
addpath(fullfile(Astro_FP, 'plot'));
addpath(fullfile(Astro_FP));
