...
Astro_FP= '/home/hakon/kode/matlab/AstroEBSD'; %please change this to your astro file path
...
InputUser.PatternLoc = fullfile('/home/hakon/kode/emsoft/em_data/test_al/pat6.bmp');  %Input a raw image file if needed, or folder
...
InputUser.Phase_Input  = {'Aluminium'}; %Si, Ferrite
...
%PC search ranges
Settings_PCin.start=[0.42 0.20 0.49];
...
Settings_Cor.radius_frac=0.85; %fraction of the pattern width to use as the mask
...
%reside
Settings_Cor.resize=0; %resize correction
